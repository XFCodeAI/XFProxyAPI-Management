...
export function ProviderColumn({
  ...
  return (
    <div className={`${styles.column} ${styles.providers}`}>
...
export function AliasColumn({
  ...
  return (
    <div className={`${styles.column} ${styles.aliases}`}>
      <div className={styles.columnHeader}>{label}</div>
      {aliasNodes.map((node) => (
        <ContextMenuTrigger key={node.id} asChild>
          <div
            ref={(el) => {
