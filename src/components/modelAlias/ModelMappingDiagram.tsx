...
const PROVIDER_COLORS = [
  ...
  'var(--primary)',
  'color-mix(in srgb, var(--primary) 75%, var(--foreground))',
  'color-mix(in srgb, var(--primary) 60%, var(--muted-foreground))',
  'color-mix(in srgb, var(--primary) 45%, var(--foreground))',
  'color-mix(in srgb, var(--primary) 35%, var(--muted-foreground))',
  'color-mix(in srgb, var(--foreground) 65%, var(--primary))',
  'color-mix(in srgb, var(--muted-foreground) 70%, var(--primary))',
];
