...
function ExpandableInput({
  ...
  return (
    <div className={`${styles.expandableInputWrapper} ${styles.expandableInputExpanded}`}>
      <textarea
        ref={textareaRef}
        className={cn(textareaClass, styles.expandableTextarea, className)}
        placeholder={placeholder}
        aria-label={ariaLabel}
        value={value}
  ...
  return (
    <div className={fieldRootClass}>
      <div className={styles.blockHeaderRow}>
        <label className={styles.inlineLabel}>{t('config_management.visual.api_keys.label')}</label>
      ...
      <div className={fieldHintClass}>{t('config_management.visual.api_keys.hint')}</div>
      ...
      >
        <div className={fieldRootClass}>
          ...
          <div id={apiKeyHintId} className={fieldHintClass}>
            {t('config_management.visual.api_keys.input_hint')}
          </div>
          {formError && (
            <div id={apiKeyErrorId} className={fieldErrorClass}>
              {formError}
            </div>
          )}
    ...
    <div className={styles.storeAuthEditor}>
      ...
      <div className={styles.actionRow}>
        <Button
          variant="secondary"
          size="sm"
          onClick={() => onChange([...value, createPluginStoreAuthRule()])}
          disabled={disabled}
        >
...
export const PayloadRulesEditor = memo(function PayloadRulesEditor({
  ...
  const renderConditionValueEditor = (
    ...
    if (condition.valueType === 'json') {
      return (
        <textarea
          className={cn(textareaClass, styles.payloadJsonInput)}
