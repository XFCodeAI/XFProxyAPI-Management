...
import styles from './SponsorProviderPanel.module.scss';

interface SponsorProviderPanelProps {
  resource: ProviderResource | null;
  workbench: UseProviderWorkbenchResult;
  mutationDisabled?: boolean;
}

export function SponsorProviderPanel({
  resource,
  workbench,
  mutationDisabled = false,
}: SponsorProviderPanelProps) {
      ...
      <section className={styles.panel}>
        <div className={styles.header}>
          <div className={styles.titleRow}>
            {logo ? <img src={logo.src} alt="" aria-hidden="true" className={styles.logo} /> : null}
        ...
        <div className={styles.empty}>
          ...
          <div className={styles.emptyActions}>
            ...
            <a
              className={`${styles.linkButton} ${styles.registerLinkButton}`}
  ...
  return (
    <section className={styles.panel}>
      ...
      <div className={styles.footer}>
        ...
        <Button type="submit" form={formId} disabled={submitDisabled} loading={submitting}>
          {mode === 'create' ? <IconPlus size={16} /> : <IconCheckCircle2 size={16} />}
