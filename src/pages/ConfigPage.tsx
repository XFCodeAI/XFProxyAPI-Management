    ...
    <div className={styles.floatingActionContainer} ref={floatingActionsRef}>
      <div className={styles.floatingActionList}>
        ...
        <TooltipIconButton
          ...
          label={t('config_management.save')}
        >
          <IconCheck size={16} />
              ...
              <div className={styles.sourceToolbar}>
                <div className={styles.searchInputWrapper}>
                  <Input
                    ...
                    disabled={disableControls || loading}
                    wrapperClassName={styles.searchInputRoot}
                    ...
                    rightElement={
                      <div className={styles.searchRight}>
                        ...
                        <TooltipIconButton
                          ...
                          label={t('config_management.search_button', { defaultValue: '搜索' })}
                        >
                          <IconSearch size={16} />
                        </TooltipIconButton>
                      </div>
                ...
                <div className={styles.searchActions}>
                  <TooltipButton
                    ...
                    label={t('config_management.search_prev', { defaultValue: '上一个' })}
                  >
                  ...
                  <TooltipButton
                    ...
                    label={t('config_management.search_next', { defaultValue: '下一个' })}
                  >
